...
const Trends = () => {
  ...
  <div className='flex flex-row justify-between items-center'>
       ...
       <button onClick={() => setOpen(!open)} className='flex flex-row px-2 py-2 justify-between items-center rounded-full border border-[#e2e4e4] gap-x-2  text-xs md:text-sm'>Monthly  <ChevronDownIcon /></button>
       {open && 
